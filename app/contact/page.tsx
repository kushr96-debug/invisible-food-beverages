...
export default function ContactPage() {
  return (
    <div className={`min-h-screen ${theme.bg} ${theme.textMain} pt-20`}>
      ...
      <section id="faq" className="mx-auto grid max-w-7xl gap-10 border-b border-white/5 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1fr_1.5fr] lg:gap-16 lg:px-8 lg:py-24">
        <div>
        ...
        <div className={`grid gap-10 rounded-3xl border ${theme.border} ${theme.surface} p-5 sm:p-8 md:p-12 lg:grid-cols-[1.5fr_1fr] lg:gap-12`}>
          ...
          <form className="grid gap-6 md:grid-cols-2 md:gap-7">
            ...
            <fieldset className="md:col-span-2">
              ...
              <div className="flex flex-col gap-4 text-base font-medium text-gray-200 sm:flex-row sm:flex-wrap sm:gap-8 sm:text-lg">
