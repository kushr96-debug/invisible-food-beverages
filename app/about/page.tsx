    ...
    <div className="bg-[#091612] text-white">
      <section className="relative overflow-hidden px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <p className="mt-8 max-w-3xl text-lg leading-8 text-white/65 sm:text-xl sm:leading-9">Invisible Food & Beverages connects international importers, distributors, and food manufacturers with carefully sourced Indian grains, spices, herbs, oil seeds, and value-added ingredients.</p>
        </div>
      </section>
      ...
      <section id="team" className="bg-[#11231D] py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-bold uppercase tracking-[0.3em] text-[#D4FF00]">Our team</p>
          <div className="mt-8 grid gap-10 lg:grid-cols-2 lg:items-end"><h2 className="text-3xl font-semibold sm:text-4xl md:text-5xl">Specialists in procurement, quality checks, and export readiness.</h2><p className="text-lg leading-8 text-white/65">We work with trusted suppliers and logistics partners to help buyers plan consistent volumes and category expansion.</p></div>
        </div>
      </section>
